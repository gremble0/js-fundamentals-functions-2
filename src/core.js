...
function calculatePreparationTime(numCakeLayers) {
  return numCakeLayers * 3
}
...
function totalTimeSpent(numCakeLayers, minutesInOven) {
  return calculatePreparationTime(numCakeLayers) + minutesInOven
}
